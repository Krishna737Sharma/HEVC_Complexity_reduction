...
def reload_loss_and_accuracy():
    global train_accuracy_list, valid_accuracy_list, train_loss_list, valid_loss_list
    file = open('results/loss_accuracy_list.dat', 'r+')
...
f = open('results/loss_accuracy_list.dat', 'w+')
...
for i in range(len(step_list)):
    f.write("%d  %g  %g  %g  %g  %g  %g  %g  %g  %g  %g  %g  %g  %g  %g  %g  %g  %g  %g\r\n" % (step_list[i],
                                                                                                ...
                                                                                                train_accuracy_list[i][
                                                                                                    2],
                                                                                                valid_accuracy_list[i][
                                                                                                    0],
                                                                                                valid_accuracy_list[i][
                                                                                                    1],
                                                                                                valid_accuracy_list[i][
                                                                                                    2],
                                                                                                train_tendency_list[i][
                                                                                                    0],
                                                                                                train_tendency_list[i][
                                                                                                    1],
                                                                                                train_tendency_list[i][
                                                                                                    2],
                                                                                                valid_tendency_list[i][
                                                                                                    0],
                                                                                                valid_tendency_list[i][
                                                                                                    1],
                                                                                                valid_tendency_list[i][
                                                                                                    2]))
f.close()
shutil.copyfile('results/loss_accuracy_list.dat', 'Models/loss_accuracy_list_%s.dat' % get_time_str())
