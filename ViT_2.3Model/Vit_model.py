...
train_file_path = "/root/myproject/HEVC_Intra_Models-ViT/Data/AI_Train_2446725.dat_shuffled"
validation_file_path = "/root/myproject/HEVC_Intra_Models-ViT/Data/AI_Valid_143925.dat_shuffled"
...
for epoch in range(start_epoch, num_epochs):
    ...
    if num_patience_counter_changed >= 5:
        ...
        new_validation_loader, new_validation_indices = create_subset_dataloader(validation_file_path, VALIDSET_MAXSIZE, 60000, BATCH_SIZE, shuffle=False)
        # Log dataset changes
    ...
    wandb.log({"epoch": epoch+1, "train_loss": avg_loss, "train_accuracy": avg_acc,  "train_accuracy_L1": avg_acc_l1, "train_accuracy_L2": avg_acc_l2, "train_accuracy_L3": avg_acc_l3})
    ...
    if (epoch+1) % 2 == 0:
        ...
        wandb.log({"epoch": epoch+1, "val_loss": avg_val_loss, "val_accuracy": avg_val_acc,  "val_accuracy_L1": avg_val_acc_l1, "val_accuracy_L2": avg_val_acc_l2, "val_accuracy_L3": avg_val_acc_l3})
