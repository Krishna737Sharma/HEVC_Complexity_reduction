...
test_file_path = "/home/ai-iitkgp/PycharmProjects/HEVC_Intra_Models-ViT/Data/AI_Test_287850.dat_shuffled"  # update with your actual test file
TESTSET_MAXSIZE = 287850 # example value; change as necessary
BATCH_SIZE = 64

# Create the test dataloader (here we use a subset of the test set)
test_loader, test_indices = create_subset_dataloader(test_file_path, TESTSET_MAXSIZE, 287850, BATCH_SIZE, shuffle=False)
...
class VisionTransformer(nn.Module):
    def __init__(
            ...
            embed_dim=256,  # Adjust as desired (256 or 512)
            depth=12,
            num_heads=8,
            mlp_ratio=4.0,
            dropout=0.1
...
# ==================== Training Setup ====================
wandb.login(key="ab1c96668eaecaa5466157b1fa3017eedbefb310")
wandb.init(
...
# Load the checkpoint
checkpoint = torch.load("/home/ai-iitkgp/PycharmProjects/HEVC_Intra_Models-ViT/ViT_2.3M/best_vit_model.pth", map_location=device)
